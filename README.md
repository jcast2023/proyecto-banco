...
* **URL:** http://localhost:8090 (Admin: `admin` / `admin`)
* **Realm:** `banco-realm`
...
Acceso a la interfaz de pruebas: [http://localhost:8080/swagger-ui.html](http://localhost:8080/swagger-ui.html)
...
**Ejemplo de log:** `[DEBUG] c.b.bff.aspect.LogAspect - Tracking ID: [REQ-123] - Iniciando orquestación para cliente.`
...
3. **Ejecutar el request:** Usar el código de éxito `Q0xJLTAwMQ==` (Base64 de CLI-001).

---

## 📂 Estructura de la Entrega
```text
EF_DAWII_Castillo_Julio/
